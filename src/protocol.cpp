...
*****************************************************************************/
STATIC u8 dp_download_switch_1_handle(CONST u8 value[], u16 length)
{
    #define relay 10
    //示例:当前DP类型为BOOL
    u8 ret;
 ...
 * @note   MCU需要自行实现该功能
 */
void open_module_time_serve_result(CONST u8 value[], u16 length)
{
    ...
    switch(sub_cmd) {
        ...
        case 0x02: {  //子命令  模块时间服务通知
            ...
            u8 time_type = value[1]; //0x00:格林时间  0x01:本地时间
            u8 time_data[7];
